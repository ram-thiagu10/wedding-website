...
const translations = {
  ta: {
    ...
    venue1City: '81/D-1 ஒட்டார்பாளையம், ஒண்டிப்புதூர் அஞ்சல், இருகூர் பிரிவு டிரிச்சி ரோடு, எல்&டி பைபாஸ் அருகில், கோயம்புத்தூர், தமிழ்நாடு அடையாளம்: சரஸ்வதி மருத்துவமனை அருகில், பைபாஸ் சந்திப்பு',
    venue1Landmark: 'எல்லைக்குறி : சரஸ்வதி மருத்துவமனை அருகில், பைபாஸ் சந்திப்பு',
    ...
    wishPlaceholder: 'பிரசாந்த் ர & ஐஸ்வர்யா ஜனனி அ-க்கு உங்கள் மனமார்ந்த வாழ்த்துக்களை எழுதுங்கள்',
    ...
    groomName: 'பிரசாந்த் ர',
    brideName: 'ஐஸ்வர்யா ஜனனி அ',
    contactGanesan: 'கணேசன்',
    contactDhamodharan: 'தாமோதரன்',
    contactAlagudurai: 'அழகுதுரை',
    contactManoj: 'மனோஜ்'
  }
};
...
(function(){
  ...
  const weddingDate = new Date('2026-10-25T07:00:00+05:30');
  ...
  const COUPLE_ID = 'prashanth-iswarya';
