...
(function(){
  ...
  const translations = {
    ...
    en: {
      ...
      envBlessings: "🪔 &nbsp; With our families' love and support &nbsp; 🪔",
      ...
      // event1Name: "💍 Engagement",
      // event1Time: "8:30 AM - 9:30 AM",
      event2Name: "🌸 Wedding",
      event2Time: "11:20 AM - 11:56 AM",
      event3Name: "🎊 Reception",
      event3Time: "12:00 PM - 2:00 PM",
      ...
      footerNote: "Made with love · Two families, one shared beginning",
    ...
    ta: {
      ...
      heroEyebrow: "✨ &nbsp; எங்கள் குடும்பங்கள் மற்றும் நண்பர்களுடன் இணைந்து, இரண்டு உள்ளங்கள் இணையும் இந்நாளைக் கொண்டாட உங்களை அன்போடு அழைக்கிறோம். &nbsp; ✨",
      heroWeds: "❤️",
      heroDate: "செப்டம்பர் 2026 &nbsp;·&nbsp; கேரளா & தமிழ்நாடு",
      envTitleTop: "✨ &nbsp; இணையேற்பு அழைப்பிதழ் &nbsp; ✨",
      envBlessings: "🪔 &nbsp; எங்கள் குடும்பங்களின் அன்புடனும் வாழ்த்துகளுடனும் &nbsp; 🪔",
      envTapPrompt: "அழைப்பிதழைத் திறக்க முத்திரையைத் தொடவும்",
      countdownLabel: "இணையேற்பிற்கான கவுண்ட்டவுன்",
      ...
      // event1Time: "காலை 8:30 - 9:30",
      event2Name: "🌸 இணையேற்பு",
      event2Time: "காலை 11:20 - 11:56",
      event3Name: "🎊 வரவேற்பு",
      event3Time: "மதியம் 12:00 - 2:00",
      ...
      openMaps: "கூகுள் மேப்ஸில் திறக்கவும்",
      calenderSave: "கேலண்டர்ல சேவ் செய்ய",
      venuesEyebrow: "வழிகாட்டி",
      ...
      howToReach: "இங்கு வருவது எப்படி",
      ...
      footerNote: "அன்புடன், ஒரு புதிய வாழ்க்கையின் தொடக்கம்",
      ...
      galleryLabel: "அழகிய தருணங்களைப் பதிவு செய்யுங்கள்",
    ...
    ml: {
      ...
      navWishes: "ആശംസകൾ",
      heroEyebrow: "✨ &nbsp; ഞങ്ങളുടെ ജീവിതയാത്രയിലെ ഒരു പുതിയ തുടക്കം സുഹൃത്തുക്കൾക്കും കുടുംബാംഗങ്ങൾക്കുമൊപ്പം ആഘോഷിക്കാൻ ഞങ്ങൾ നിങ്ങളെ സ്നേഹപൂർവ്വം ക്ഷണിക്കുന്നു. &nbsp; ✨",
      heroWeds: "❤️",
      ...
      envTapPrompt: "ക്ഷണക്കത്ത് തുറക്കാൻ മുദ്രയിൽ സ്പർശിക്കുക",
      ...
      // event1Name: "💍 നിശ്ചയം",
      // event1Time: "രാവിലെ 8:30 - 9:30",
      event2Name: "🌸 വിവാഹം",
      event2Time: "രാവിലെ 11:20 - 11:56",
      event3Name: "🎊 വരവേൽപ്പ്",
      event3Time: "ഉച്ചയ്ക്ക് 12:00 - 2:00",
      ...
      calenderSave: "കലണ്ടറിൽ കുറിച്ചു വെച്ചോ",
      ...
      howToReach: "വേദിയിലെത്താനുള്ള വഴി",
      ...
      footerNote: "സ്നേഹത്തോടെ ഒരുക്കിയത് · രണ്ട് കുടുംബങ്ങൾ, ഒരു മനോഹരമായ തുടക്കം",
      ...
      gallerySubLabel: "പകർത്തി അപ്‌ലോഡ് ചെയ്യൂ",
